export const swagger = {
  //Mobile
  MobileAuth: 'Mobile Auth Operations',
  MobileUser: 'Mobile User Operations',
  ...
  RestaurantOrder: 'Restaurant Order Operations',
  RestaurantCoupon: 'Restaurant Coupon Operations',
};
